...
2026-09-18 UTC — R28 boundary gates accepted (full comparison AUDITS/ROUND_028_BOUNDARY_RECONSTRUCTION_COMPARISON.md): The attractive observable drift is bF-U, b=c(1-1/N)-nu ell; original source is U+cF/N. Initial/terminal two-time products remain correlated. Terminal fusion variance is (N+2)/N² and the surviving current Haar law does not identify the initial law under rare survival.

2026-09-18 UTC — R28 THM054 accepted: Initial auxiliary h_L=min(g,L)-m_L at L0 N² has zero mean and exact good-event shift; original dynamics/reference/source are unchanged. Raw force tail retains O(r) row and mixed same-label S_t subtraction.
